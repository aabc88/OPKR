...
CAR_INFO: Dict[str, Union[CarInfo, List[CarInfo]]] = {
  ...
  CAR.TRAX: CarInfo("Chevrolet TRAX 2024", "Adaptive Cruise"),
...
DBC = {
  ...
  CAR.TRAX: dbc_dict('gm_global_a_powertrain_generated', 'gm_global_a_object', chassis_dbc='gm_global_a_chassis'),
}
